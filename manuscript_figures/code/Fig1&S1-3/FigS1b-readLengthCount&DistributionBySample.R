...
IVT_7SK <- read.table("RN7SK-IVT-1.sup-pseU.notrim.id.length.txt", sep="\t", header=T, stringsAsFactors=FALSE)
IVT_EBER <- read.table("EBER2-IVT-3.sup-pseU.notrim.id.length.txt", sep="\t", header=T, stringsAsFactors=FALSE)
