...
bedFile1 <- fread('./ARPE19_uninf-1_bwa_W13k6T20.merged.VTRNA1.sorted.bedgraph', col.names = c('chromosome', 'start', 'end', 'value'))
...
models<-makeTxDbFromGFF("gencode.v45.annotation.gtf")
