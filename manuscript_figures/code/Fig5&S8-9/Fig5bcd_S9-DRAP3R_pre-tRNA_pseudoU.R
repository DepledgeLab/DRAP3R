...
bed <- read.table("ARPE19_uninf-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed", 
...
# Generate heatmap
pdf("pseU_uninf-1_tRNAs_spliced.pdf", width = 8, height = 8)
...
pdf("pseU_uninf-1_GLUonly_tRNAs_spliced.pdf", width = 12, height = 6)
...
pdf("pseu_modlevel_pretRNA_DRAP3R_uninf-1.pdf", width = 8, height = 4)
modplot
dev.off()
