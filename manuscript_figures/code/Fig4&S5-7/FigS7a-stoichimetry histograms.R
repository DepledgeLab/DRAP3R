...
file_groups <- list(
  m6A_sites = list(
    files = list(
      "FigS7acd-ARPE19_uninf-2.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed",
      "FigS7acd-ARPE19_uninf-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed",
      "FigS7acd-CRO-AP5-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38_EBV_KSHV.modFilt.0.98.hg38-tRNAs.intersect.bed",
      "FigS7acd-NHDF-uninf-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed",
      "FigS7acd-ARPE19_siLa-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed"
    ),
    variable_names = list(
  ...
  pseU_sites = list(
    files = list(
      "FigS7acd-ARPE19_uninf-2.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed",
      "FigS7acd-ARPE19_uninf-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed",
      "FigS7acd-CRO-AP5-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38_EBV_KSHV.modFilt.0.98.hg38-tRNAs.intersect.bed",
      "FigS7acd-NHDF-uninf-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed",
      "FigS7acd-ARPE19_siLa-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.hg38-tRNAs.intersect.bed"
    ),
    variable_names = list(
  ...
  PolIIItx_sites = list(
    files = list(
      "FigS7acd-ARPE19_uninf-2.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-ARPE19_uninf-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-CRO-AP5-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38_EBV_KSHV.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-NHDF-uninf-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-ARPE19_siLa-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-RN7SK-IVT-1.sup-m6A_bwa_W13k6T20.SR.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed"
    ),
    variable_names = list(
      "ARPE19_uninf_rep2_PolIIItx_m6A_sites",
      "ARPE19_uninf_rep1_PolIIItxA_m6A_sites",
  ...
  PolIIItx_pseU_sites = list(
    files = list(
      "FigS7acd-ARPE19_uninf-2.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-ARPE19_uninf-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-CRO-AP5-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38_EBV_KSHV.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-NHDF-uninf-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-ARPE19_siLa-1.sup-pseU_bwa_W13k6T20.SR.primary-merged.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed",
      "FigS7acd-RN7SK-IVT-1.sup-pseU_bwa_W13k6T20.SR.HG38.modFilt.0.98.PolIIItx.primaryOnly.intersect.bed"
...
rep1<-ggplot() +
  geom_histogram(data = ARPE19_uninf_rep2_tRNA_pseU_sites, aes(x = frac_mod), 
                 binwidth = 2, fill = "#5979bc", alpha = 0.9, color = "black", boundary = 0, linewidth = 0.75, linetype = "solid") +  # First histogram
  geom_histogram(data = ARPE19_uninf_rep2_tRNA_m6A_sites, aes(x = frac_mod), 
...
rep2<-ggplot() +
  geom_histogram(data = ARPE19_uninf_rep2_PolIIItx_pseU_sites, aes(x = frac_mod), 
                 binwidth = 2, fill = "#5979bc", alpha = 0.9, color = "black", boundary = 0, linewidth = 0.75, linetype = "solid") +  # First histogram
  geom_histogram(data = ARPE19_uninf_rep2_PolIIItx_m6A_sites, aes(x = frac_mod), 
                 binwidth = 2, fill = "red", alpha = 0.9, color = "black", boundary = 0, linewidth = 0.75, linetype = "solid") +  # Second histogram
  scale_x_continuous(limits = c(0, 100), breaks = seq(0, 100, by = 20)) +
...
#UNINF1
uninf1m<-ggplot() +
  geom_histogram(data = ARPE19_uninf_rep1_tRNA_pseU_sites, aes(x = frac_mod), 
                 binwidth = 2, fill = "#5979bc", alpha = 0.9, color = "black", boundary = 0) +  # First histogram
  geom_histogram(data = ARPE19_uninf_rep1_tRNA_m6A_sites, aes(x = frac_mod), 
...
#LaKD
lakdt<-ggplot() +
  geom_histogram(data = ARPE19_siLa_rep1_tRNA_pseU_sites, aes(x = frac_mod), 
                 binwidth = 2, fill = "#5979bc", alpha = 0.9, color = "black", boundary = 0) +  # First histogram
  geom_histogram(data = ARPE19_siLa_rep1_tRNA_m6A_sites, aes(x = frac_mod), 
                 binwidth = 2, fill = "red", alpha = 0.9, color = "black", boundary = 0) +  # Second histogram
  scale_x_continuous(limits = c(0, 100), breaks = seq(0, 100, by = 20)) +
  labs(x = "Modification stoichiometry", y = "Count") + #, title = "ARPE19 + IFNag pre-tRNA") +  # Axis labels and title
  theme_classic() +
  theme(axis.text=element_text(colour="black")) +
  theme(
    plot.title = element_text(size = 24, hjust = 0.5),  # Title size and centering
...
lakdp<-ggplot() +
  geom_histogram(data = ARPE19_siLa_rep1_PolIIItx_pseU_sites, aes(x = frac_mod), 
                 binwidth = 2, fill = "#5979bc", alpha = 0.9, color = "black", boundary = 0) +  # First histogram
  geom_histogram(data = ARPE19_siLa_rep1_PolIIItx_m6A_sites, aes(x = frac_mod), 
                 binwidth = 2, fill = "red", alpha = 0.9, color = "black", boundary = 0) +  # Second histogram
  scale_x_continuous(limits = c(0, 100), breaks = seq(0, 100, by = 20)) +
  labs(x = "Modification stoichiometry", y = "Count") + #, title = "ARPE19 + IFNag Pol III tx") +  # Axis labels and title
  theme_classic() +
  theme(axis.text=element_text(colour="black")) +
  theme(
    plot.title = element_text(size = 24, hjust = 0.5),  # Title size and centering
...
combined_plot2 <- rep1 + uninf1m + uninf3m + lakdt + inf2m + rep2 + uninf1p + uninf3p + lakdp + inf2p + plot_layout(ncol = 5)
