...
m6A_sites <- fread("ARPE19_polyA_uninf-1.sup-m6A.hg38tx.modFilt.0.98.cov20filt.sorted.bed", header = FALSE)
...
###### SECTION FOR PROCESSING pseU DATA ######

### Read in Dorado pseU output
pseU_sites <- fread("ARPE19_polyA_uninf-1.sup-pseU.hg38tx.modFilt.0.98.cov20filt.sorted.bed", header = FALSE)
...
pdf(file = "metaplot-polyA.pdf", width = 10, height = 5) 
final
dev.off()