...
file1 <- fread('.CRO-AP5-1.sup-m6A_bwa_W13k6T20.SR.primary-merged.RN7SK.sorted.bedgraph', col.names = c('chromosome', 'start', 'end', 'value'))
file3 <- fread('.RN7SK-IVT-1.sup-m6A_bwa_W13k6T20.SR.RN7SK.sorted.bedgraph', col.names = c('chromosome', 'start', 'end', 'value'))
