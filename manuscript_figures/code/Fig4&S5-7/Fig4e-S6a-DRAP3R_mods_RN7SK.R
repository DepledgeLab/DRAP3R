...
merged_df <- merged_df %>% 
  mutate(DataBase = case_when(
    grepl("ARPE19_uninf-2", DataBase, ignore.case = TRUE) & grepl("0.98", DataBase, ignore.case = TRUE) ~ "ARPE19_uninf-2-0.98",
    grepl("ARPE19_uninf-1", DataBase, ignore.case = TRUE) & grepl("0.98", DataBase, ignore.case = TRUE) ~ "ARPE19_uninf-1-0.98",
    ...
    grepl("ARPE19_uninf-2", DataBase, ignore.case = TRUE) & grepl("noFilt", DataBase, ignore.case = TRUE) ~ "ARPE19_uninf-2 - Unfiltered",
    grepl("ARPE19_uninf-1", DataBase, ignore.case = TRUE) & grepl("noFilt", DataBase, ignore.case = TRUE) ~ "ARPE19_uninf-1 - Unfiltered",
...
desired_order<- c("CRO-AP5-0.98","NHDF - 0.98","ARPE19_uninf-1-0.98","ARPE19_uninf-2-0.98","RN7SK-IVT-1-0.98",
                  "CRO-AP5 - Unfiltered", "NHDF - Unfiltered", "ARPE19_uninf-1 - Unfiltered", "ARPE19_uninf-2 - Unfiltered", "RN7SK-IVT-1 - Unfiltered")
