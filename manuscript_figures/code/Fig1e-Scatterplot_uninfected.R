...
### Read in count files
UNINF1_Pol3pri <- read.csv('ARPE19-uninf-1_bwa_W13k6T20.merged.HG38.primary.sorted.PolIIItx.primaryOnly.count.txt', sep='\t', header = FALSE)
UNINF2_Pol3pri <- read.csv('ARPE19-uninf-2_bwa_W13k6T20.merged.HG38.primary.sorted.PolIIItx.primaryOnly.count.txt', sep='\t', header = FALSE)
UNINF1_Pol3psu <- read.csv('ARPE19_uninf-1_bwa_W13k6T20.merged.HG38.primary.sorted.PolIIItx.pseudoOnly.count.txt', sep='\t', header = FALSE)
UNINF2_Pol3psu <- read.csv('ARPE19_uninf-2_bwa_W13k6T20.merged.HG38.primary.sorted.PolIIItx.pseudoOnly.count.txt', sep='\t', header = FALSE)
UNINF1_tRNA <- read.csv('ARPE19-uninf-1_bwa_W13k6T20.merged.HG38.primary.sorted.hg38-tRNAs.count.txt', sep='\t', header = FALSE)
UNINF2_tRNA <- read.csv('ARPE19-uninf-2_bwa_W13k6T20.merged.HG38.primary.sorted.hg38-tRNAs.count.txt', sep='\t', header = FALSE)
UNINF1_SNAR <- read.csv('ARPE19_uninf-1_bwa_W13k6T20.merged.HG38.primary.sorted.SNARs.count.txt', sep='\t', header = FALSE)
UNINF2_SNAR <- read.csv('ARPE19_uninf-2_bwa_W13k6T20.merged.HG38.primary.sorted.SNARs.count.txt', sep='\t', header = FALSE)
UNINF1_noPolIII <- read.csv('ARPE19_uninf-1_bwa_W13k6T20.merged.HG38.primary.sorted.noPolIIItx.counts.txt', sep='\t', header = FALSE)
UNINF2_noPolIII <- read.csv('ARPE19_uninf-2_bwa_W13k6T20.merged.HG38.primary.sorted.noPolIIItx.counts.txt', sep='\t', header = FALSE)
...
pdf(file = "uninf.pdf", width = 7, height = 7)
uninf_bioreps
dev.off()
