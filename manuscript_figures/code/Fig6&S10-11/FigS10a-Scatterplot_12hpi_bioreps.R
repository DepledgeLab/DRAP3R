...
### Read in count files
INF1_Pol3pri <- read.csv('ARPE19-HSV1-12hpi-1_bwa_W13k6T20.merged.HG38.primary.sorted.PolIIItx.primaryOnly.count.txt', sep='\t', header = FALSE)
INF2_Pol3pri <- read.csv('ARPE19-HSV1-12hpi-2_bwa_W13k6T20.merged.HG38.primary.sorted.PolIIItx.primaryOnly.count.txt', sep='\t', header = FALSE)
INF1_Pol3psu <- read.csv('ARPE19-HSV1-12hpi-1_bwa_W13k6T20.merged.HG38.primary.sorted.PolIIItx.pseudoOnly.count.txt', sep='\t', header = FALSE)
INF2_Pol3psu <- read.csv('ARPE19-HSV1-12hpi-2_bwa_W13k6T20.merged.HG38.primary.sorted.PolIIItx.pseudoOnly.count.txt', sep='\t', header = FALSE)
INF1_tRNA <- read.csv('ARPE19-HSV1-12hpi-1_bwa_W13k6T20.merged.HG38.primary.sorted.hg38-tRNAs.count.txt', sep='\t', header = FALSE)
INF2_tRNA <- read.csv('ARPE19-HSV1-12hpi-2_bwa_W13k6T20.merged.HG38.primary.sorted.hg38-tRNAs.count.txt', sep='\t', header = FALSE)
INF1_SNAR <- read.csv('ARPE19-HSV1-12hpi-1_bwa_W13k6T20.merged.HG38.primary.sorted.SNARs.count.txt', sep='\t', header = FALSE)
INF2_SNAR <- read.csv('ARPE19-HSV1-12hpi-2_bwa_W13k6T20.merged.HG38.primary.sorted.SNARs.count.txt', sep='\t', header = FALSE)
INF1_noPolIII <- read.csv('ARPE19-HSV1-12hpi-1_bwa_W13k6T20.merged.HG38.primary.sorted.noPolIIItx.counts.txt', sep='\t', header = FALSE)
INF2_noPolIII <- read.csv('ARPE19-HSV1-12hpi-2_bwa_W13k6T20.merged.HG38.primary.sorted.noPolIIItx.counts.txt', sep='\t', header = FALSE)
...
pdf(file = "inf_12hpi_bioreps.pdf", width = 6, height = 6)
inf_bioreps
dev.off()
